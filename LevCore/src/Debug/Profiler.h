...
#define LEV_PROFILE_END_SESSION() ::LevEngine::Instrumentor::Get().EndSession()
#define LEV_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::LevEngine::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
