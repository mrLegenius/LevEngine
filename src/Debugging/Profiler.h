...
#define LEV_FUNC_SIG __PRETTY_FUNCTION__
#elif defined(__DMC__) && (__DMC__ >= 0x810)
#define LEV_FUNC_SIG __PRETTY_FUNCTION__
#elif (defined(__FUNCSIG__) || (_MSC_VER))
#define LEV_FUNC_SIG __FUNCSIG__
#elif (defined(__INTEL_COMPILER) && (__INTEL_COMPILER >= 600)) || (defined(__IBMCPP__) && (__IBMCPP__ >= 500))
#define LEV_FUNC_SIG __FUNCTION__
...
#define LEV_PROFILE_BEGIN_SESSION(name, filepath) ::LevEngine::Profiler::Get().BeginSession(name, filepath)
#define LEV_PROFILE_END_SESSION() ::LevEngine::Profiler::Get().EndSession()
#define LEV_PROFILE_SCOPE_LINE2(name, line) constexpr auto fixedName##line = ::LevEngine::ProfilerUtils::CleanupOutputString(name, "__cdecl ");\
											   ::LevEngine::ProfilerTimer timer##line(fixedName##line.Data)
...
#define LEV_PROFILE_SCOPE(name)
#define LEV_PROFILE_FUNCTION()
#endif