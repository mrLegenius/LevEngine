...
std::shared_ptr<Mesh> Mesh::CreateCube()
{
	...
	//indices
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(0, 1, 2));
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(0, 2, 3));
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(4, 5, 6));
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(4, 6, 7));
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(8, 9, 10));
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(8, 10, 11));
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(12, 13, 14));
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(12, 14, 15));
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(16, 17, 18));
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(16, 18, 19));
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(20, 21, 22));
	mesh->AddTriangle(DirectX::SimpleMath::Vector3(20, 22, 23));
