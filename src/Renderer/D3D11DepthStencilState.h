...
public:
	...
	void SetDepthMode(const DepthMode& depthMode) { m_DepthMode = depthMode; }
    const DepthMode& GetDepthMode() const { return m_DepthMode; }

    void SetStencilMode(const StencilMode& stencilMode) { m_StencilMode = stencilMode; }
    const StencilMode& GetStencilMode() const { return m_StencilMode; }
