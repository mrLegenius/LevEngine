...
namespace LevEngine
{
    ...
    AssetsBrowser::AssetsBrowser() : m_CurrentDirectory(g_AssetsPath)
    {
        m_DirectoryIcon = Texture2D::Create("Resources/Icons/AssetsBrowser/DirectoryIcon.png");
        m_FileIcon = Texture2D::Create("Resources/Icons/AssetsBrowser/FileIcon.png");
    }

    void AssetsBrowser::OnImGuiRender()
    {
