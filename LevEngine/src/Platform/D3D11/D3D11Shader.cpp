...
namespace LevEngine
{
    ...
    void D3D11Shader::CreateInputLayout(ID3DBlob* vertexBlob)
    {
        ...
        for (uint32_t i = 0; i < numInputParameters; ++i)
        {
            ...
            // TODO: Figure out how to deal with per-instance data? .. Maybe just use structured buffers to store per-instance data and use the SV_InstanceID as an index in the structured buffer.
